                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-info shadow-primary border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0"><?php echo e(__('login.sign_in')); ?></h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <form role="form" action="<?php echo e(url('login')); ?>" class="text-start" method="post">

                                <div class="form-group mt-3 mb-3 input-group input-group-static">
                                    <label for="loginEmail" class="form-label"><?php echo e(__('login.email')); ?></label>
                                    <input type="email" class="form-control" id="loginEmail" name="email">
                                </div>
                                <div class="form-group mt-3 mb-3 input-group input-group-static">
                                    <label class="form-label" for="loginPassword"><?php echo e(__('login.password')); ?></label>
                                ...
                                <p class="mt-4 text-sm text-center">
                                    <?php echo e(__('login.dont_have_acc')); ?>

                                    <a href="<?php echo e(url('register')); ?>"
                                       class="text-primary text-gradient font-weight-bold"><?php echo e(__('login.sign_up')); ?></a>
                                </p>
                                <?php echo csrf_field(); ?>

                                <button class="btn btn-info w-100" id="registerBtn"><?php echo e(__('login.login')); ?></button>
                            </form>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/donation-website/resources/views/client/login.blade.php ENDPATH**/ ?>