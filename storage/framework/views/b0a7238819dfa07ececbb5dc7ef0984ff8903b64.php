...
<head>
    ...
    <title>
        <?php echo e(env('APP_NAME').' | Client Register'); ?>
                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-info shadow-primary border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0"><?php echo e(__('register.sign_up')); ?></h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <form role="form" action="<?php echo e(url('register')); ?>" class="text-start" method="post">

                                <div class="form-group input-group input-group-static my-3">
                                    <label for="" class=""><?php echo e(__('register.name')); ?></label>
                                    <input type="text" class="form-control" required name="name">
                                </div>
                                <div class="form-group input-group input-group-static my-3">
                                    <label for=""><?php echo e(__('register.email')); ?></label>
                                    <input type="email" class="form-control" required name="email">
                                </div>
                                <div class="form-group input-group input-group-static my-3">
                                    <label for=""><?php echo e(__('register.gender')); ?></label>
                                    <select name="gender" class="form-control" id="">
                                        <option value="1"><?php echo e(__('register.male')); ?></option>
                                        <option value="0"><?php echo e(__('register.female')); ?></option>
                                    </select>
                                </div>
                                <div class="form-group my-3 input-group input-group-static ">
                                    <label for=""><?php echo e(__('register.dob')); ?></label>
                                    <input type="date" class="form-control" required name="date">
                                </div>


                                <div class="form-group my-3 input-group input-group-static ">
                                    <label for=""><?php echo e(__('register.password')); ?></label>
                                ...
                                <p class="mt-4 text-sm input-group input-group-static">
                                    <label>
                                        <input type="checkbox" id="tosCheck" class="" name="tosAgreement">
                                        <?php echo e(__('register.by_creating')); ?> <a href="<?php echo e(asset('pdf/tos.pdf')); ?>"
                                                                            download="" class="text-bold">
                                            <?php echo e(__('register.tos')); ?></a>.
                                    </label>
                                ...
                                <p class="mt-4 text-sm text-center">
                                    ...
                                    <a href="<?php echo e(url('login')); ?>"
                                       class="text-primary text-gradient font-weight-bold"><?php echo e(__('register.sign_in')); ?></a>
                                </p>
                                <?php echo csrf_field(); ?>

                                <button class="btn btn-info w-100" disabled id="registerBtn"><?php echo e(__('register.register')); ?></button>
                            </form>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/donation-website/resources/views/client/register.blade.php ENDPATH**/ ?>