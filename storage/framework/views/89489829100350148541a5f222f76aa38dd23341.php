                        ...
                        <form action="<?php echo e(url('admin/users/'.$user->id.'/update')); ?>" method="post">
                            <div class="form">
                                ...
                                <div class="form-group input-group input-group-static mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email" required value="<?php echo e($user->email); ?>">
                                </div>

                                <div class="form-group input-group input-group-static mb-3">
                                    <label for="" class="">DATE OF BIRTH</label>
                                    <input type="date" class="form-control" name="date" required value="<?php echo e($user->dateOfBirth); ?>">
                                </div>
                                ...
                                <div class="form-group input-group input-group-static  mb-3">
                                    ...
                                    <select name="gender" id="" class="form-control ">
                                        ...
                                        <option value="0" <?php if($user->gender == 0): ?> selected <?php endif; ?>>Female</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group input-group input-group-static  mb-3">
                                    ...
                                    <select name="role" id="" class="form-control ">
                                        <option value="0" <?php if($user->role == 0): ?> selected <?php endif; ?>>Client</option>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/donation-website/resources/views/admin/users-update.blade.php ENDPATH**/ ?>